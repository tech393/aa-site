...
// Archived prior design of /spiritual-life-coach-certification. Kept reachable
// for reference only; canonicalises to itself and is hidden from search engines
// so it doesn't compete with the new live page for the certification keyword.
export const metadata: Metadata = {
  title: { absolute: "Cert Page (Previous Design) | Awakened Academy" },
  description: "Archived prior design of the Spiritual Life Coach Certification page.",
  alternates: { canonical: "/cert-old" },
  robots: { index: false, follow: false },
  openGraph: {
    title: "Cert Page (Previous Design) | Awakened Academy",
    description: "Archived prior design of the Spiritual Life Coach Certification page.",
    url: `${SITE.url}/cert-old`,
  },
};
