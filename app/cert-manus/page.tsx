...
// Variant of the certification page based on the Manus mockup:
// - same structure & copy as /spiritual-life-coach-certification
// - NO lead-capture form anywhere; every CTA routes to /schedule (discovery call)
// - hero is single-column copy with two buttons (no right-hand form panel)
// - adds a trust-strip stat band immediately under the hero

export const metadata: Metadata = {
  title: "Spiritual Life Coach Certification (Manus Mockup)",
  description:
    "Become a certified spiritual life coach. Discovery-call funnel mockup variant based on the Manus design.",
  alternates: { canonical: "/cert-manus" },
  robots: { index: false, follow: false },
  openGraph: {
    title: "Spiritual Life Coach Certification (Manus Mockup)",
    description: "Discovery-call funnel mockup variant based on the Manus design.",
...
export default function CertManusPage() {
  return (
    <>
      ...
      {/* HERO, single-column copy on Sedona, two CTAs, no form */}
      ...
      {/* TRUST STRIP, stat band straight under hero */}
      <TrustStrip variant="cream" kicker="Trusted worldwide" />
      ...
      {/* FINAL CTA, no form, just discovery-call buttons */}
          ...
          <Reveal>
            ...
            <div className="mt-9 flex flex-wrap justify-center gap-4">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 rounded border border-white/45 px-7 py-3.5 text-[13.5px] font-medium uppercase tracking-[0.12em] text-white transition hover:border-white hover:bg-white/10"
              >
                Re-read the Curriculum <span aria-hidden>↑</span>
              </Link>
            </div>
          </Reveal>
        </div>
      ...
      <StickyCTABar
        ...
        subtitle="Free discovery call · No commitment · 25+ countries"
